...
async function testWhisper() {
  try {
    ...
    try {
      ...
      console.log('   💡 faster-whisper is compatible with Python 3.12 and 4x faster!\n');
      return;
    }
...
"`;
    ...
    if (fs.existsSync(envPath)) {
      ...
      const transcriptionMatch = envContent.match(/DUB_TRANSCRIPTION_ENGINE=(\w+)/);
    ...
    console.log('   • Short audio (<10 min) uses Groq (faster) with fallback\n');
